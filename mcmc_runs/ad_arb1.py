...
def make_model():
    ...
    def fg(a=a):
        ...
        f = 0.5*(res1['exp_u_pi_0']+res2['exp_u_pi_0'])
    ...
    def loglike(value=1.0, fg=fg, gamma=gamma):
        f = fg[0]
        g = fg[1:]
        return gamma*f*5. + gamma*10.0*(min(0., g[0]) + min(0., g[1]))
        # return gamma * f + \
...
if __name__ == '__main__':
    ...
    smc.initialize(0.1)
    results = []
    for gamma in np.linspace(0., 30, 30)[1:]:
        smc.move_to(gamma)
...
# max f =  0.4906577160797098 g =  [0.22028071 0.03785899]
# >  [0.00234358 0.44158853 1.09513737]
