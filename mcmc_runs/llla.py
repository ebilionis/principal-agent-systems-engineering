...
if __name__ == '__main__':
    ...
    smc = SteadyPaceSMC(mcmc, num_particles=500, num_mcmc=1, verbose=4,
                 gamma_is_an_exponent=True,
                 ess_reduction=0.6, adapt_proposal_step=True,
                 mpi=mpi)
    smc.initialize(0.01)
    for gamma in np.linspace(.0, 80.0, 800)[1:]:
        smc.move_to(gamma)
...
# {'exp_u_pi_agents': [[0.017195655308422337]],
#  'exp_u_pi_0': array(0.97381557),
#  'e_stars': [0.6663257172411604],
#  'd_exp_u_pi_0_da': array([-1.        , -0.97032389,  0.02857195, -0.21747064])}
