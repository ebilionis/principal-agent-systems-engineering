...
number_opt = 8	# Set numer of restarts
comm = MPI.COMM_WORLD
rank = comm.rank
size = comm.size
if rank == 0:
	...
	q_coeff 			  = [0.64145697, 0.04650573, 1.97937449] # Coefficients to define the quality function
	ucoeff                = 2.0									 # Utility coefficient (RA, RN, RP)
